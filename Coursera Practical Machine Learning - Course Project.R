...
setwd("C:\\Users\\dsmith\\Documents\\data-science\\FinalProject")
source(".\\Lib-Packages.R")
source(".\\Lib-IO.R")
source(".\\Lib-Random.R")
source(".\\Lib-MachineLearning.R")
CleanSession()
## --------------- Instructions ---------------------------
# Background
# 
...
# Peer Review Portion
# 
# Your submission for the Peer Review portion should consist of a link to a Github repo with 
# your R markdown and compiled HTML file describing your analysis. Please constrain the text of 
# the writeup to < 2000 words and the number of figures to be less than 5. It will make it easier 
# for the graders if you submit a repo with a gh-pages branch so the HTML page can be viewed 
...
libraries <- c("quantmod", "gbm","glmnet","caret",
               "data.table","pROC","e1071","ElemStatLearn",
               "AppliedPredictiveModeling", "pgmm", "rpart", "rpart.plot",
               "plyr", "lubridate", "forecast", "lars", "ggplot2", 
               "knitr", "xtable", "randomForest", "doMC", "sqldf", "rattle")
#install.packages("doMC", repos="http://R-Forge.R-project.org")
#library("doMC")
# Use the above for doMC on Windows machines..

LoadPkgByList(libraries)

InitializeRepeatableSeed()
## --------------- Project specifc Code  ---------------------------
ClearScreen()
LoadDataFromWeb()

executeML_DecisionTree()

executeML_RandomForest()
